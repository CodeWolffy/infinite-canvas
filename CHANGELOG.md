...
+ [优化] 针对中转站与高并发场景全面优化后端性能与安全性：Gemini 协议改用 x-goog-api-key 请求头避免密钥在日志中泄露并增强 NewAPI 兼容，媒体资源支持不可变强缓存与 ETag 协商，媒体删除改为批量事务与批量对象删除，优化渠道状态更新行锁排队，新增纯 IP 登录限流、安全响应头与用户活跃任务排队上限，修复文本失败请求幂等重试。
